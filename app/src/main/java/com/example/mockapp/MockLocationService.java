...
public class MockLocationService extends Service {
    ...
    private Notification createNotification() {
        ...
        return new NotificationCompat.Builder(this, CHANNEL_ID)
                ...
                .setContentText("Simulando hacia: " + lat + ", " + lng)
    ...
    private void startMocking() {
        ...
        try {
            ...
            Log.e(TAG, "Excepción de seguridad: Opciones de Desarrollador -> Elegir aplicación para simular ubicación no configurado.", e);
            stopSelf();
            return;
            ...
            public void run() {
                while (isMocking) {
                    ...
                    try {
                        ...
                        Log.e(TAG, "Excepción de seguridad al simular", e);
                        break;
                    } catch (Exception e) {
